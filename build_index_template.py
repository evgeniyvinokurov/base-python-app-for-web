...
projects = [
    {"name": "vksearchgroupsposts", "tags": ["vk", "js", "ai"], "files": [], "github": True, "pro": True},
...
for p in pwis: 
    ...
    if not os.path.isfile(file):
        ...
        if "video" not in p:
            ...
            pwiht['htmlcodes'] += "<video controls width='250'><source src='/static/" + videosrc + "' type='video/mp4' /></video>"
        if "github" not in p:
